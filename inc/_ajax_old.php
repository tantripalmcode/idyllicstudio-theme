...
function ajax_pc_check_availability()
{
    ...
    if ($event_id) {
        ...
        $total_capacity_used = get_data_event_booking_capacity($event_id, $today_date, $time_selected);
        ...
        if ($day_data && $today) {
            ...
            $response['timeNow'] = $timeNow;

            // Create a DateTime object from the string
            $date = DateTime::createFromFormat('F j, Y', $datum);
            ...
            for ($time = $start_time; $time < $end_time; $time += $interval) {
                ...
                // $eventDateTime = $date->format('Y-m-d') . " " . $start;
