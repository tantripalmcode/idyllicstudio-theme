...
?>
<div class="ep-box-col-12 ep-position-relative" id="ep-sl-right-area">
    ...
    if( ( ! empty( $args->event->em_enable_booking ) && $args->event->em_enable_booking != 'bookings_off' ) || ( ep_get_global_settings( 'show_qr_code_on_single_event' ) == 1 ) ) {?>
        <div class="ep-box-row ep-border ep-rounded text-center"><?php
                ...
                if( $args->event->post_status == 'publish' || ( ! empty( $all_tickets ) && count( $all_tickets ) > 0 ) ) {
                    if( ! $is_event_expired ) {?>
                        <div class="ep-box-col-12 ep-px-4 ep-pt-3">
                            <span class="ep-fs-4">Buchung für <?php echo esc_html( wp_strip_all_tags( $args->post->post_title ) ); ?></span>
                        </div><?php
                    }?>
                        ...
                        <div class="ep-box-row">
                            ...
                            if( $em_event_seating_type == 'seats' ) {
                                ...
                                <div class="ep-box-col-4 ep-box-col-sm-4" id="ep_event_ticket_modal_right">
                                    ...
                                    <div id="ep_event_booking_ticket" class="d-none" data-ticket_options=""></div>
                                    <div class="ep-text-small ep-my-2 ep-rounded ep-p-2 d-none">
